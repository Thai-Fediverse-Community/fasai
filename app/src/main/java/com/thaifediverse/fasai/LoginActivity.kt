...
import com.thaifediverse.fasai.adapter.ServerListAdapter
import com.thaifediverse.fasai.di.Injectable
import com.thaifediverse.fasai.entity.AccessToken
import com.thaifediverse.fasai.entity.AppCredentials
...
import com.thaifediverse.fasai.util.rickRoll
import com.thaifediverse.fasai.util.shouldRickRoll
...
class LoginActivity : BaseActivity(), Injectable {
    ...
    private var serverListAdapter: ServerListAdapter? = null

    private var instanceList = listOf<String>(
            "mastodon.in.th",
            "pleroma.in.th",
            "norze.world",
            "thaitodon.social",
...
//        }
        ...
        //Add server list.
        serverListAdapter = ServerListAdapter(this, instanceList)
        rcServer.apply {
            setHasFixedSize(true)
            layoutManager = LinearLayoutManager(this@LoginActivity)
            adapter = serverListAdapter
        }
        serverListAdapter?.setOnClickServer(object : ServerListAdapter.OnClickServer{
            override fun onSelectServer(urlInstance: String?) {
                connectServer(urlInstance)
            }
        })
    ...
    private fun connectServer(serverUrl: String?) {

        val domain = canonicalizeDomain(serverUrl ?: "")
